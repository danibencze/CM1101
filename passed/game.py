...
def remove_punct(text):
    ...
    'goSouTh'
    """
    remove1 = "".join(text.split("."))
    remove2 = "".join(remove1.split("-"))
    remove3 = "".join(remove2.split("!"))       #Working
    remove4 = "".join(remove3.split("?"))
    remove5 = "".join(remove4.split(","))


    return remove5 # The pass statement does nothing. Replace it with the body of your function.
...
def normalise_input(user_input):
    ...
    'help'
    """
    remove1 = "".join(user_input.split("."))
    remove2 = "".join(remove1.split("-"))
    remove3 = "".join(remove2.split("!"))
    remove4 = "".join(remove3.split("?"))       #Working
    remove5 = "".join(remove4.split(","))
    lower = remove5.lower()
...
def display_room(room):
    ...
    print()
    print(room["description"])          #WORKING
    print()
    return # The pass statement does nothing. Replace it with the body of your function.
